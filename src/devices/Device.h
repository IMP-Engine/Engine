...
public:
    ...
    // TODO Stop and start should be used to pass particles, constraints and triangles. Not the constructor
    virtual void stop(ParticleData & particles, ConstraintData & constraints) = 0;
    virtual void start(ParticleData & particles, ConstraintData & constraints) = 0;
