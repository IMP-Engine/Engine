...
public:
    ...
    bool solveDistanceConstraint(glm::vec3 &delta1, glm::vec3 &delta2, int constraintIndex, ParticleData &particleData, bool stabilize, float & dLambda, float lambda, float dt);
