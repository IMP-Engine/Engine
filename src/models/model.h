...
namespace model {
	...
	*/
	void loadPredefinedModel(std::string model, ParticleData &particles, std::vector<Constraint*> &constraints, modelConfig config);
	...
	*/
	void loadModel(std::string name, ParticleData &particles, std::vector<Constraint*> &constraints, modelConfig c);
